...
Paste it as the value for that package in `links.json` and push. Apps without a link show
a disabled "Test link not set" button and still link to their Play Store page.
